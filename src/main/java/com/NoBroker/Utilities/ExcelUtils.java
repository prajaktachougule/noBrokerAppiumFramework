...
import com.installerApp.pages.BaseTest;
...
public class ExcelUtils extends BaseTest {
    ...
    public static void setExcelFileSheet(String sheetName) throws Exception {
        ...
        try {
            // Open the Excel file
            FileInputStream ExcelFile = new FileInputStream("/Users/Ashwin/eclipse-workspace/InstallerAppDemoTest/src/main/java/com/installerApp/TestData/installerAppData.xlsx");
    ...
    public static void setCellData(String value, int RowNum, int ColNum) throws Exception {
        try {
        	setExcelFileSheet("Sheet 1");
        	if(excelWSheet==null) {
        		System.out.println("excelsheet=null");
        	}
            row = excelWSheet.getRow(RowNum);
            ...
            FileOutputStream fileOut = new FileOutputStream("/Users/Ashwin/eclipse-workspace/InstallerAppDemoTest/src/main/java/com/installerApp/TestData/installerAppData.xlsx");
